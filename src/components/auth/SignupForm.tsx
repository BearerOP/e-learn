...
export const SignupForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        toast.promise(
            ...
            },
            {
                ...
                error: (err) => err.response.data.message || 'Failed to sign up. Please try again.',
            }
        );
    };
    ...
    return (
        <div className="max-w-md mx-auto p-6 bg-card rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-center mb-6">Sign Up for GyanSagar</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    }} id="username" type="username" placeholder="Enter your username" required />
                </div>
                <div className="space-y-2">
